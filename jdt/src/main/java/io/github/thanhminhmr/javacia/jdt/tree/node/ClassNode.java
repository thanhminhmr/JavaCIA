...
public final class ClassNode extends AbstractParameterizedModifiedAnnotatedNode implements JavaClassNode {
	...
	private @Nullable AbstractType extendsClass;

	private transient @NotNull List<@NotNull AbstractType> implementsInterfaces = List.of();


	public ClassNode(@Nullable SourceFile sourceFile, @NotNull AbstractNode parent, @NotNull String name,
	...
	@Override
	public @Nullable AbstractType getExtendsClass() {
		return extendsClass;
	}
	...
	@Override
	public @NotNull List<@NotNull AbstractType> getImplementsInterfaces() {
		return isFrozen() ? implementsInterfaces : Collections.unmodifiableList(implementsInterfaces);
	}

	public void setImplementsInterfaces(@NotNull List<@NotNull AbstractType> implementsInterfaces) {
		assertNonFrozen();
