...
import io.github.thanhminhmr.javacia.jdt.tree.node.attribute.AbstractAnnotatedNode;
import io.github.thanhminhmr.javacia.tree.node.JavaPackageNode;
...
public final class PackageNode extends AbstractAnnotatedNode implements JavaPackageNode {
	...
	public PackageNode(@NotNull AbstractNode parent, @NotNull String name) {
