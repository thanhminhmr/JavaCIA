...
import io.github.thanhminhmr.javacia.jdt.project.Module;
import io.github.thanhminhmr.javacia.jdt.project.ProjectSnapshot;
...
import io.github.thanhminhmr.javacia.jdt.project.builder.parameter.JavaBuildParameter;
...
import io.github.thanhminhmr.javacia.utils.RelativePath;
...
public final class SnapshotBuilder {
	...
	private static double @NotNull [] calculateWeights(double @NotNull [] dependencyWeights,
			@NotNull List<? extends JavaNode> allNodes) {
	...
	private static @NotNull Map<@NotNull String, @NotNull SourceFile> createJavaSourceFileMap(
			@NotNull BuildInputSources inputSources) {
		...
		for (final BuildInputSources.InputModule inputModule : inputSources) {
			...
			for (final BuildInputSources.InputSourceFile inputSourceFile : inputModule) {
				...
				final SourceFile sourceFile = new SourceFile(module,
	...
	public static @NotNull ProjectSnapshot build(@NotNull String snapshotName,
	...
	private static <E extends SnapshotBuildParameter> @Nullable E getParameter(
			@NotNull Set<@NotNull SnapshotBuildParameter> parameters, @NotNull Class<E> parameterClass) {
